...
for i in range(10000):
    ...
    url = "https://statsnet.co/companies/uz/%D0%A2%D0%90%D0%A8%D0%9A%D0%95%D0%9D%D0%A2%D0%A1%D0%9A%D0%90%D0%AF%20%D0%9E%D0%91%D0%9B%D0%90%D0%A1%D0%A2%D0%AC?page=" + str(i)
    time.sleep(2)
    ...
    for ultag in soup.find_all('ul', {'class': 'space-y-2'}):
        ...
        for p in ultag.find_all('p', {'class': 'text-sm text-gray-500'}):
            if p.text.startswith('БИН'):
                ...
                print(stir)
                with open("tashkentvil.txt", "a") as myfile:
                    myfile.write(stir+"\n")
